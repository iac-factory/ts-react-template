...
import { createStyling, Theme } from 'react-base16-styling';
...
export const getDefaultThemeStyling = theme => {
...
export const getStyle: ( theme ) => unknown = theme => {
...
export const style = ( theme: string = "rjv-default", component?: string | LoDashStatic, args?: Theme) => {
    if (!theme) {
